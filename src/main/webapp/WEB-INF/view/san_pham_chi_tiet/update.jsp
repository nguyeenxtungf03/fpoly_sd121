        ...
        <div class="row">
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <textarea name="moTa"  required type="textarea" class="form-control">${spct.moTa}</textarea>
                        <div class="invalid-feedback">
    ...
    <div class="col-md-12" >
        <form style=" box-shadow: 0 0 4px 6px rgba(0, 0, 0, 0.1);" class="row needs-validation" novalidate method="post" enctype="multipart/form-data"
            ...
            <div style="display: none">
                ...
                <input type="number" name="giaBan" maxlength="50" class="form-control"
                       value="${spct.giaBan}" required>
                <input type="number" name="soLuong" maxlength="50" class="form-control"
                       value="${spct.soLuong}" required>
                <input type="text" name="moTa" maxlength="50" class="form-control"
                       value="${spct.moTa}" required>
                <input type="text" name="trangThai"  class="form-control"
                       value="${spct.trangThai}" required>
...
<style>
    ...
    .capNhat {
        ...
        border-radius: 8px;
        overflow: hidden;
        box-shadow: 1px 0 4px 6px rgba(0, 0, 0, 0.1);
        padding: 40px;
        margin-top: 20px;
    }
</style>
...
<!-- Thư viện Bootstrap (bao gồm Popper.js) -->
