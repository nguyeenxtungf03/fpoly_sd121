...
<div class="container">
    ...
    <div>
        <div class="row">
            ...
            <form action="/khach-hang/searchTK"  >
                Tìm kiếm <input name="key" value=""  style="border: 2px solid black ;border-radius: 5px ;height: 37px " type="search" placeholder="Search...">
                <button class="btn btn-secondary" style="color: black " type="submit"><i class="bi bi-search"></i> Tìm kiếm</button>
                <a class="btn btn-secondary"  href="/khach-hang/hien-thi">
    ...
    <table class="table table-hover" style="font-size: 13px ; font-weight: 400">
        <thead>
        ...
        <tr>
            ...
            <td scope="row" ><fmt:formatDate value="${kh.ngaySinh}" pattern="dd-MM-yyyy"></fmt:formatDate></td>
            ...
            <td scope="row">
                <c:if test="${kh.trangThai == 1}">
                    <form action="/khach-hang/trangThaiHuy">
                        ...
                        <button style="background: red ; border-radius: 5px"  type="submit">Hủy kích hoạt</button>
                    </form>
                </c:if>
                ...
                <c:if test="${kh.trangThai == 2}">
                    <form action="/khach-hang/trangThaiKichHoat">
                        <input style="display: none" name="idKh" value="${kh.id}">
                        <button style="background: #34ce57d ; border-radius: 5px" type="submit">Kích hoạt</button>
                    </form>
                </c:if>
            </td>
